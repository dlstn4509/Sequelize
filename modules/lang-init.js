		...
		case 'KO':
			return {
				...
				GLOBAL: {
					...
					NAVI					: ['도서 등록', '도서 리스트', '로그인', '로그아웃', '회원가입', '마이페이지', '정보수정', '도서리스트 Vue', '회원탈퇴']
				},
				LIST: {
					TITLE 				: '도서 목록',
		...
		case 'EN': 
			return {
				...
				GLOBAL: {
					...
					NAVI: 				['Book Register', 'Book List', 'Login', 'Logout', 'Join', 'my page', 'Edit member information', 'Book List(Vue)', 'Withdrawal']
				},
				LIST: {
					TITLE 				: 'Book List',
				...
				MYPAGE : {
					...
					USERNAME			: 'User name',
					EMAIL					: 'Email',
					DOMAIN				: 'authentication platform',
					APIKEY				: 'authentication key',
					KAKAO					: 'Verified member with Kakao',
					NAVER					: 'Verified member with Naver',
				},
				BT: {
					UPDATE				: 'UPDATE',
					DELETE				: 'DELETE',
